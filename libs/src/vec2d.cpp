...
#include <cmath>
namespace LOEF {
vec2d::vec2d(millimetre_quantity x, millimetre_quantity y) {
    this->x_ = x;
    this->y_ = y;
}
vec2d::vec2d(const QPoint &point, dot_per_millimetre_quantity dpmm) {
    this->x_ = static_cast<double>(point.x()) / dpmm;
    this->y_ = static_cast<double>(point.y()) / dpmm;
}
vec2d::vec2d(const QPointF &point, dot_per_millimetre_quantity dpmm) {
    this->x_ = static_cast<double>(point.x()) / dpmm;
    this->y_ = static_cast<double>(point.y()) / dpmm;
}
millimetre_quantity vec2d::length() const {
...
millimetre_quantity vec2d::x() const noexcept { return x_; }
millimetre_quantity vec2d::y() const noexcept { return y_; }
...
QPoint vec2d::to_QPoint(dot_per_millimetre_quantity dpmm) { return QPoint(x_ * dpmm, y_ * dpmm); }
QPointF vec2d::to_QPointF(dot_per_millimetre_quantity dpmm) { return QPointF(x_ * dpmm, y_ * dpmm); }
